      ...
      <div data-flex class="hide-scroll">
          <nav class="scroll nav-stacked nav-stacked-rounded nav-color">
            ...
            <ul class="nav" data-ui-nav>
              ...
              <li>
                <a href="{{ url('/classroom/index') }}" class="b-danger" title="Class Rooms">
                  <span class="nav-icon text-white no-fade">
        ...
        <div class="padding">
          ...
          <div class="row-col">
            <div class="col-xs-6 col-sm-3 col-md-4 b-r b-b">
                ...
                <a href="{{url('classroom/index')}}" class="btn btn-info btn-lg">Show</a>
            </div>
                <!-- inline search class -->
              <!-- <div class="col-xs-6 col-sm-3 col-md-4">
                <form action="">
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search for class" style="width:300px;" name="search">
            ...
            <div class="row-col table-responsive">
              <table class=" table table-hover ">
                  ...
                  {{-- <tr>
                        ...
                        <td>first floor</td>
                        <td>
                        <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#editclassModal" >edit</a>
