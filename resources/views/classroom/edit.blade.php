  ...
  <div id="content" class="app-content box-shadow-z2 bg pjax-container" role="main">
    <div class="app-header white bg b-b">
          <div class="navbar" data-pjax>
                ...
                <div class="navbar-item pull-left h5" id="pageTitle">Edit</div>
                <!-- nabar right -->
...
<div class="row-col" col-sm-12>
  <div class="col-lg b-r">
    <div class="row no-gutter">
      <div class="col-xs-6 col-sm-6  col-md-6 b-r b-b">
        ...
        <div class="padding">
          ...
          <!-- classroom -->
    <div class="row col-sm-8 pull-center">
        @if(count($classobj) >0)

          <form action="{{ url('classroom/update/'.$classobj->id) }}" method="POST">
                      {{ csrf_field() }}
                      {{ method_field('PUT') }}
                      <div class="form-group">
                        <label for="class-name">Name of class: </label>
                        <input type="text" name="class_name" class="form-control" id="class-name" required="required" value='{{$classobj->name}}'>
                      </div>
                        <div class="form-group">
                          <label for="class_capacity">Classroom capacity</label>
                          <input type="number" required="required" name="class_capacity" value="0" id="class_capacity" class="form-control" value='{{$classobj->capacity}}'>
                        </div>
                        <div class="form-group">
                          <label for="class_floor">Floor name: </label>
                          <input type="text" required="required"  name="class_floor" id="class_floor" class="form-control" value='{{$classobj->floor}}'>
                        </div>
                      <div class="form-group">
                        <label for="class_location">Location: </label>
                        <input type="text" name="class_location" required="required" id="class_location" class="form-control" value='{{$classobj->location}}'>
                        <input type="hidden" value="PUT" name="_method">
                      </div>
                      <div class="form-group">
                        <button type="submit" class="btn btn-lg form-btn btn-success">save</button>
                        
                        <a href="{{ url('classroom') }}" class="btn btn-lg form-btn btn-danger">Close</a>
                      </div>
                  </form>
               @endif
    ...
    <div class="padding">
      ...
      <!-- Display table data and create classroom -->
